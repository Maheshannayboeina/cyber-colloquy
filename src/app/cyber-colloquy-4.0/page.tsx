...
import { FaShieldAlt, FaCalendarAlt, FaMicrophone, FaUsers, FaArrowRight } from 'react-icons/fa'; // Import icons
  ...
  return (
    <Container>
      ...
      >
        ...
        >
          <FaShieldAlt className="text-blue-500 dark:text-blue-400 text-4xl" /> {/* Icon - Shield for Security */}
          <div>
        ...
        >
          <h3 className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-4 flex items-center space-x-2">
            <FaCalendarAlt className="text-blue-500" /> {/* Icon - Calendar for Events */}
            <span>Event Highlights</span>
          </h3>
          <ul className="list-disc pl-8 text-gray-700 dark:text-gray-300 space-y-2">
            <li><b>Keynote Presentations:</b> Leading experts sharing valuable insights.</li>
            <li><b>Panel Discussions:</b> Engaging dialogues on critical challenges.</li>
            <li><b>Workshops & Tech Sessions:</b> Hands-on knowledge and practical skills.</li>
            <li><b>Networking:</b> Connect with professionals, and students.</li>
            <li><b>Student Showcase:</b> Discover projects and innovation.</li>
          </ul>
        </motion.div>
        ...
        >
          <h3 className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-4 flex items-center space-x-2">
            <FaMicrophone className="text-blue-500" /> {/* Icon - Mic for Learning/Speaking */}
          ...
          <ul className="list-disc pl-8 text-gray-700 dark:text-gray-300 space-y-2">
            ...
            <li>Expand Network: Connect with professionals and fellow students.</li>
        ...
        >
          <h3 className="text-xl font-semibold text-blue-600 dark:text-blue-400 mb-4 flex items-center space-x-2">
            <FaUsers className="text-blue-500" /> {/* Icon - Users for Community */}
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-300 mb-6">
            Don&apos;t miss out! Register to secure your spot and be part of the conversation.
          </p>
          <a
          ...
          >
            Register for Cyber Colloquy 4.0 <FaArrowRight className="ml-2" /> {/* Icon */}
          </a>
        </motion.div>
      </motion.div>
    </Container>

...
const NominationsPage: React.FC = () => {
  return (
    <Container>
      ...
      >
        Please find the registration forms below for various events and
        opportunities.
      </SectionTitle>
      ...
      <motion.div
        className="bg-gray-900 p-8 rounded-lg shadow-md mb-8 max-w-screen-md mx-auto animate-fade-in-container"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      {/* End of form sections container - motion.div */}
    </Container>
  );
};

    ...
    const data: Patent[] = [
      {
        ...
        inventors:
          "Dr. Nilakshi Jain, Dr. Shwetambari Borade, Maj Vineet Kumar",
      ...
      },
      {
        ...
        inventors:
          "Dr Shwetambari Borade, Ms. Priyanka Singh, Maj Vineet Kumar",
      ...
      },
      {
        sNo: 3,
        patentTitle:
          "Decentralized Cyber Incident Reporting and Management System",
      ...
      },
      {
        ...
        inventors:
          "Dr.Rupali Vairagade, Ms Meghali Kalyankar, Maj Vineet Kumar",
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-8">
        {paginatedPatents.map((patent, index) => (
          <div
            ...
            } shadow-md rounded-md p-0 transition-all duration-300 hover:shadow-lg aspect-square backdrop-blur-sm`}
              ...
              <div className="px-1 h-full flex flex-col justify-center">
                ...
                {hoveredCard !== index ? (
                  ...
                  <div className="text-left w-full px-5">
                    ...
                    <p className="text-gray-400 text-m mb-1">
                      <span className="font-bold">Patent Number:</span>{" "}

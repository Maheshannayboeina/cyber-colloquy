...
import {
  ...
  FaQuestionCircle,
  FaArrowRight,
} from "react-icons/fa"; // Import icons - CalendarAlt and QuestionCircle
...
const ProjectExpoPage: React.FC = () => {
  return (
    <Container>
      ...
      >
        Discover innovation, network with experts, and celebrate the best
        projects in Cyber Security.
      </SectionTitle>

      <motion.div
        className="bg-gray-800 rounded-2xl shadow-xl mb-12 max-w-screen-lg mx-auto overflow-hidden" // Added overflow-hidden
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="relative h-[200px] w-full"> {/* Adjust height as needed */}
          <Image
            src="/img/banners/6.png" // Replace with your banner image path in public directory
        ...
        <div className="p-10"> {/* Padding for content moved inside */}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <p className="text-gray-400">
                  Showcase your creativity, innovation, and technical expertise at
                  Project EXPO, where students present groundbreaking projects
                  across various domains! Whether it's cybersecurity, AI, IoT,
                  software development, robotics, or any other field, this is your
                  platform to shine.
                </p>
              </div>
            </motion.div>
            ...
            >
              Be a part of an event that celebrates innovation and technological
              advancements! Don’t miss the chance to showcase your project and
              make an impact. 🚀
            </motion.p>
          </motion.div>

...
const AwardCeremonyPage: React.FC = () => {
  return (
    <Container>
      ...
      <motion.div
        className="bg-gray-800 rounded-2xl shadow-xl mb-12 max-w-screen-lg mx-auto overflow-hidden" // Updated styling - keeping consistent with SponsorPage and added overflow-hidden
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="relative h-[200px] w-full"> {/* Adjust height as needed */}
          <Image
            src="/img/banners/8.png" // Replace with your banner image path in public directory

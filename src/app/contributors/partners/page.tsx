...
const partners: Partner[] = [
  { name: "Partner 1", description: "A leading tech company.",imageUrl: "/img/partners/partner1.jpg" },
  { name: "Partner 2", description: "Specializes in network security.",imageUrl: "/img/partners/partner2.jpg" },
              ...
              {partners.map((partner, index) => (
                <motion.div
                 ...
                 >
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-100 mb-2">{partner.name}</h3>
                   {partner.description && (

...
const events = [
  ...
  
  {
    ...
    location: "Seminar Hall",
    images: ["/img/events/colloquy4.0_banner_2.png", "/img/events/event10.jpg"],
    tags: ["cybersecurity", "colloquy", "quantum computing", "data science"],
    colloquyDetails: {
      conductedBy: "CYSE Department",
      topics: ["Quantum Computing", "Threat Intelligence", "Cyber Warfare","Cyber Kill Chain","Offensive Security","Defensive Security"],
    },
    activities: [
      {
        date: "21st March",

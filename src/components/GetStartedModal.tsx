...
const GetStartedModal: React.FC<GetStartedModalProps> = ({
  ...
  return (
    ...
    >
      <div
        ref={modalRef}
        className="bg-gray-800 rounded-lg p-8 w-full max-w-lg relative"
      >
        <button
          onClick={onClose}
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex flex-col space-y-4 ">
            <button
              ...
              className="block px-4 py-2 text-lg font-normal text-gray-200 no-underline rounded-md hover:text-indigo-500 focus:text-indigo-500 focus:bg-gray-800 focus:outline-none text-center"
            >
              Play a Game
            </button>
            {playGameOpen && (
              <div className="flex  mt-2 justify-center gap-8">
                <Link
                  href="/phishing"
                  onClick={onClose}
                  className="flex flex-col items-center p-6 rounded-md bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-500 w-1/2"
                >
                  <span className="mb-4">

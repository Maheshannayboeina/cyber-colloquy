...
export function AchievementCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-xl overflow-hidden" // Removed fixed h-[400px]
    >
      ...
      <div className="absolute bottom-0 left-0 w-full p-4 sm:p-6 z-10">
        ...
        <div className="space-y-1">
          <div className="flex justify-between items-start mb-0.5">
            <span className="px-2 sm:px-3 py-0.5 sm:py-1 bg-purple-500/20 text-purple-400 text-xs sm:text-sm font-medium rounded-full">
              {" "}

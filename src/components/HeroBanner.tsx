    ...
    <div className="relative w-full h-full">
      <div className="relative h-full">
        <Image
          ...
          placeholder="blur"
        />
        <div className="absolute bottom-0 left-0 p-4 sm:p-6 md:p-8 w-full bg-gradient-to-t from-black to-transparent flex items-start justify-center sm:justify-between text-center sm:text-left">
          <div className="sm:max-w-md md:max-w-2xl lg:max-w-3xl">
            <BoxReveal>
            ...
            <BoxReveal duration={0.75}>
              <p className="text-base sm:text-lg text-gray-300 mb-4">{subtitle}</p>

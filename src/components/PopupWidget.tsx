        ...
        {({ open }) => (
          <div>
            ...
            <Transition
              ...
              as="div"
            >
              <DisclosurePanel className=" flex flex-col  overflow-hidden left-0 h-full w-full sm:w-[350px] min-h-[250px] sm:h-[600px] border border-gray-800 bg-white shadow-2xl rounded-md sm:max-h-[calc(100vh-120px)]">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} noValidate>
                      ...
                      <div className="mb-4">
                        ...
                        <input
                          ...
                          className={`w-full px-3 py-2 text-gray-200 placeholder-gray-500 bg-gray-700 border border-gray-600 rounded-md focus:outline-none focus:ring   ${
                            errors.name
                      ...
                      <div className="mb-4">
                        ...
                        <textarea
                          ...
                          className={`w-full px-3 py-2 text-gray-200 placeholder-gray-500 bg-gray-700 border border-gray-600 rounded-md h-28 focus:outline-none focus:ring   ${
                            errors.message
                              ? "border-red-600 focus:border-red-600 ring-red-100"
                              : "border-gray-300 focus:border-indigo-600 ring-indigo-100"
                          }`}
